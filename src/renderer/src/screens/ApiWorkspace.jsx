...
import SharedCodeArea, { highlightCode } from '../components/CodeArea'
...
// The body editor is the shared CodeArea (transparent textarea over a highlighted <pre>) plus
// this screen's {{token}} picker layered on top.
function CodeArea({ value, onChange, bodyType, placeholder, height = 240, extraGroups = [] }) {
  const taRef = useRef(null), btnRef = useRef(null)
  ...
  return (
    <SharedCodeArea value={value} onChange={onChange} kind={kind} placeholder={placeholder} height={height} taRef={taRef}>
